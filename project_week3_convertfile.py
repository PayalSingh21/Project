# -*- coding: utf-8 -*-
"""Project_week3_ConvertFile.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WgjNbhDtFyaT6PFChTBv-XLv1gJVvRRR
"""
...
path='/content/19313_Eagle_in_a_circle_V1_NEW.obj.stl.ply'

process_pt_file(path)

#total_data=process_pt_file(path)

def convert_data(path=''):
    if(len(path)<1): #Command line mode
        if len(sys.argv) != 2:
            print("Error: Incorrect number of input arguments. Input only a single argument, either a single pt cloud or a single directory \
                    containing multiple point clouds")
            exit()
        path = sys.argv[1]
...
a = (scaler.transform(dataset))
print(a)

open('norm.npy', mode='w')
np.save('norm.npy', a)
...
make_pt_clouds(total_data, 1000, 5000, '20.h5',randomizePoint=True)
